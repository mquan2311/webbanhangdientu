<%-- 
    Document   : error
    Created on : Dec 3, 2020, 10:24:00 PM
    Author     : memft
--%>
...
<html>
  ...
  <meta property="og:description" content="TimsahTim | 404">
...
<svg id="svgWrap_2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 700 250">
  ...
  </g><!-- <" TimsahTim Tarafından Yapışmıştır, 404 Hata Açık Kaynak Kodu! ">-->
</svg>
...
<h2 onclick="window.open('index.jsp','_self')">PAGE NOT FOUND, SORRY ABOUT THIS ERROR</h2>
<style> 
