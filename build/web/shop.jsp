<%-- 
    Document   : shop
    Created on : Dec 3, 2020, 11:01:30 PM
    Author     : memft
--%>
            ...
            <div class="wrap">
                ...
                <div class="cont span_2_of_3">
                   ...
                   //     Product product = new Product();
                    ...
                    %> 
                    <div class="box1">
                        <div class="col_1_of_single1 span_1_of_single1"><a href="addtocart?itemid=<%=itemid%>&username=<%=username%>">
                                <div class="view1 view-fifth1">
                                    <div class="top_box">
                                        <h3 class="m_1"><%=itemname%></h3>
                                        <p class="m_2"><%=itemdes%></p>
                                        <div class="grid_img">
                                            <div class="css3"><img src="<%=itemimg%>" alt=""/></div>
                                            <div class="mask1">
                                ...
                                <ul class="list2">
                                    <li>
                                        ...
                                        <ul class="icon1 sub-icon1 profile_img">
                                            <li><a class="active-icon c1" href="#">More info</a>
                                                <%if (itemstock == 0) {%>
                                                <ul class="sub-icon1 list">
                                                    <li><h3>Stock : <%=itemstock%></h3></li>
                                                    <li><p>Sorry if we are out of stock<br><a href="">contract to order</a></p></li>
                                                </ul>
                                                <%} else {%>
                                                <ul class="sub-icon1 list">
                                                    <li><h3>Stock : <%=itemstock%></h3></li>
                                                    <li><p>Hope you enjoy<br><a href="">contract here</a></p></li>
                                                </ul>  
                                                <% } %>
                                            </li>
                                        </ul>
                    ...
                    <!--                    <div class="box1">
                                            <div class="col_1_of_single1 span_1_of_single1"><a href="single.jsp">
                                                    <div class="view1 view-fifth1">
                                                        <div class="top_box">
                                                            <h3 class="m_1">TEN</h3>
                                                            <p class="m_2">DES</p>
