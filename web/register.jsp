          	...
          	<div class="wrap">
    		   ...
    		   <form action="insertinfo?action=user" method="post">
    			 ...
    			 <div class="col_1_of_2 span_1_of_2">
		    			...
		    			<div><input type="text" name="showname" value="Show name" onfocus="if (this.value == 'Show name') {this.value='';}" onblur="if (this.value == '') {this.value = 'Show name';}"></div>
		    			<div><input type="text" name="email" value="E-Mail" onfocus="if (this.value == 'E-Mail') {this.value='';}" onblur="if (this.value == '') {this.value = 'E-Mail';}"></div>
                                        
		    			<div><input type="text" name="password" value="Password" onfocus="if (this.value == 'Password') {this.value='';}" onblur="if (this.value == '') {this.value = 'Password';}"></div>
		    	 </div>
		    	  <div class="col_1_of_2 span_1_of_2">	
		    		<div><input type="text" name="address" value="Address" onfocus="if (this.value == 'Address') {this.value='';}" onblur="if (this.value == '') {this.value = 'Address';}"></div>
                                ...
                                <div><input type="text" value="District" name="country" onfocus="if (this.value == 'District') {this.value='';}" onblur="if (this.value == '') {this.value = 'District';}"></div>
		            		        
                                <div><input type="text" name="city" value="City" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'City';}"></div>
		            <div> <input type="text" name="phone" value="Phone Number" class="number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Phone Number';}"></div>
<!--		          	 <p class="code"></p>-->
		          </div>
